...
**Graph 2.** Other species had a count of less than 25 on a given date.


---

```{r}
#Insectivores registered at Deveroux Slough
#species_count %>% filter(location == "DEVEREUX SLOUGH", general_type == "Insectivores") 
```
...
**Graph 3.** Other species had a count of less than 20 on a given date.

<br>
<br>

**Table 1.** Seed and fruit eaters registered at Deveroux Slough
```{r}
species_count %>% filter(location == "DEVEREUX SLOUGH", general_type == "Seed & Fruit Eaters") 
```
...
omnivores_species <- species_count %>% 
    filter(location == "NCOS") %>% 
...
ggplot(omnivores_species) + 
    geom_bar(position="stack", stat="identity", aes(fill=species, y=n, x=observation_date))+
      scale_fill_manual(values = c("#4E84C4", "#C4961A", "#D16103","azure3"))+
    geom_line(data=omnivores_count, aes(x=observation_date, y=n, col=location))+
      scale_colour_grey()+
...
**Graph 4.** Other species had a count of less than 10 on a given date.

<br>
<br>

**Table 2.**  Omnivores registered at Deveroux Slough
```{r}
species_count %>% filter(location == "DEVEREUX SLOUGH", general_type == "Omnivores") 
```
